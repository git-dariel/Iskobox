  ...
  return (
    <section className="bg-gradient-to-r from-[#e9cf5e] to-[#fffbfb]   ">
      ...
      <div className="h-full md:h-[50vh]">
        <p className="flex flex-col items-center justify-center gap-5 px-10 py-5 md:px-20 md:py-0 text-justify h-full font-mono font-normal ">
          <span className="text-sm md:text-lg">{about.span3}</span>
          <span className="text-sm md:text-lg">{about.span4}</span>
        </p>
      </div>
    </section>
  );
