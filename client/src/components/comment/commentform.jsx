  ...
  return (
    <div className='flex select-none h-full border '>
      <div className='bg-white rounded-md w-full max-w-sm lg:max-w-xl overflow-hidden'>
        <div className='flex justify-between items-center gap-10 px-1 py-2 border-b border-gray-200 sm:px-6'>
          <div>
            <h3 className='text-sm font-medium leading-6 text-gray-900'>Notes</h3>
          </div>
