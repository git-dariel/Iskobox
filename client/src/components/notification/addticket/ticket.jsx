...
const TicketForm = ({ addTicketToNotifications, closeModal}) => {
  ...
  return (
    <div  className="fixed inset-0 flex items-center justify-center p-4 bg-gray-500 bg-opacity-75 transition-opacity duration-300 ease-in-out select-none">
      <div className="bg-white rounded-md   max-w-sm lg:max-w-xl w-full overflow-hidden">
        ...
        <form className="px-4 py-5 space-y-6 sm:p-6" onSubmit={handleSubmit}>
          ...
          <button
            onClick={closeModal}
            className="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 focus:outline-none focus:shadow-outline rounded-2xl"
            type="submit"
          >
            Cancel
          </button>
