    ...
    <div className=' flex items-center justify-center select-none'>
      <div className='bg-white rounded-md max-w-sm lg:max-w-xl w-full overflow-hidden'>
        <div className='flex justify-between px-4 py-5 border-b border-gray-200 sm:px-6'>
          <h3 className='text-lg font-medium leading-6 text-gray-900'>Create Request Ticket</h3>
        </div>
        ...
        <form className='' onSubmit={handleSubmit}>
          <div className='px-4 py-5 space-y-6 sm:p-6'>
            ...
            <div className='flex flex-row-reverse gap-5'>
              <button
                ref={submitButtonRef}
                className='bg-slate-600 hover:bg-blue-700 text-white font-bold py-2 px-4 focus:outline-none focus:shadow-outline rounded-2xl'
                type='submit'
              >
                Submit
              </button>
