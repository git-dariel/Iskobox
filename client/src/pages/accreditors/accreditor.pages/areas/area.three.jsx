        ...
        <section className="flex w-full justify-center bg-gradient-to-r from-amber-300 to-yellow-50 min-h-[40vh] p-7">
          <div className="flex py-4 md:w-[75%] justify-between gap-5">
            <div className="flex flex-col text-justify">
              <h1 className="md:text-2xl font-bold mb-5">{common.AREATHREE_CONTENTS.DESC}</h1>
              <p className="md:text-lg text-sm">{common.AREATHREE_CONTENTS.DESC_CONTENT}</p>
            </div>
          </div>
        </section>
                    ...
                    >
                      <header className="border w-full text-center h-full py-10">
                        ...
                        {subfolder.name === "Parameter A" && (
                          <p className="text-sm md:text-base">Curriculum and Program of Studie</p>
                        )}
                        ...
                        {subfolder.name === "Parameter C" && (
                          <p className="text-sm md:text-base">Assessment of Academic Performance</p>
                        )}

                        {subfolder.name === "Parameter D" && (
                          <p className="text-sm md:text-base">Management of Learning</p>
                        )}

                        {subfolder.name === "Parameter E" && (
                          <p className="text-sm md:text-base">Graduation Requirements</p>
                        )}
