  ...
  return (
    <div className='h-full w-full'>
      <div className='border-2'>
        <h2 className='text-2xl font-bold text-left m-5 text-gray-600'>Folder Usage</h2>
      ...
      <div className='border-2'>
        <div className='flex p-5'>
          <h2 className='text-2xl font-bold text-left text-gray-600'>Folders</h2>
        </div>
        <div className='mx-10 flex'>
          ...
          <input type='file' id='fileInput' style={{ display: 'none' }} onChange={handleAddFile} />
        </div>
            ...
            {(currentFolder ? currentFolder.subfolders : folders).map((folder) => {
              ...
              return (
                ...
                >
                  ...
                  <div className='text-xs font-semibold'>{filePercentage}% Files</div>
      ...
      >
        <div className='flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0'>
          ...
          <div className='inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full'>
            <X className='cursor-pointer p-1 float-end' onClick={() => setModalOpen(false)} />
      ...
      >
        <div className='flex items-center justify-center min-h-screen'>
          <div className='bg-white rounded-lg overflow-hidden shadow-xl transform transition-all sm:max-w-lg sm:w-full p-4'>
            <h3 className='text-lg leading-6 font-medium text-gray-900'>Edit Folder Name</h3>
            <div className='mt-2'>
              <input
                type='text'
                className='border p-2 mb-4 w-full'
